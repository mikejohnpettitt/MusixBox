...
hiphop_songs = Song.where(playlist: playlist_hiphop)
puts "#{hiphop_songs.size} hiphop songs created"
...
blues_songs = Song.where(playlist: playlist_blues)
puts "#{blues_songs.size} blues songs created"
...
rnb_songs = Song.where(playlist: playlist_rnb)
puts "#{rnb_songs.size} rnb songs created"
...
punk_songs = Song.where(playlist: playlist_punk)
puts "#{punk_songs.size} punk songs created"
...
rock_songs = Song.where(playlist: playlist_rock)
puts "#{rock_songs.size} rock songs created"
...
jazz_songs = Song.where(playlist: playlist_jazz)
puts "#{jazz_songs.size} jazz songs created"
...
soul_songs = Song.where(playlist: playlist_soul)
puts "#{soul_songs.size} soul songs created"
...
funk_songs = Song.where(playlist: playlist_funk)
puts "#{funk_songs.size} funk songs created"
...
disco_songs = Song.where(playlist: playlist_disco)
puts "#{disco_songs.size} disco songs created"
...
pop_songs = Song.where(playlist: playlist_pop)
puts "#{pop_songs.size} pop songs created"
